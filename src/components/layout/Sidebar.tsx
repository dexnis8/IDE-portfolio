...
const navItems: NavItem[] = [
  { path: "/",           label: "about.tsx",      icon: <FiUser size={13} />,      lang: "text-kiro-syn-variable dark:text-kiro-syn-variable light:text-kiro-l-syn-variable" },
  { path: "/projects",   label: "projects.tsx",   icon: <FiCode size={13} />,      lang: "text-kiro-syn-fn dark:text-kiro-syn-fn light:text-kiro-l-syn-fn" },
  { path: "/experience", label: "experience.tsx", icon: <FiBriefcase size={13} />, lang: "text-kiro-syn-keyword dark:text-kiro-syn-keyword light:text-kiro-l-syn-keyword" },
  { path: "/contact",    label: "contact.tsx",    icon: <FiMail size={13} />,      lang: "text-kiro-syn-string dark:text-kiro-syn-string light:text-kiro-l-syn-string" },
];
      ...
      <div className="flex-1 overflow-y-auto">
              ...
              return (
                <li key={item.path}>
                  ...
                  >
                    ...
                    {active && (
                      <span className="ml-auto h-1.5 w-1.5 rounded-full bg-kiro-accent
        ...
        <div className="px-4 py-3">
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 flex-shrink-0 overflow-hidden rounded-md border border-kiro-border
            ...
            <div className="min-w-0">
              <p className="truncate font-sans text-xs font-semibold text-kiro-text
                            dark:text-kiro-text light:text-kiro-l-text">
                Isaac Ayorinde
              </p>
              <p className="truncate font-mono text-[10px] text-kiro-muted
          ...
          {/* Location */}
          <p className="mt-2 font-mono text-[10px] text-kiro-muted
                        dark:text-kiro-muted light:text-kiro-l-muted">
            📍 Lagos, Nigeria
          </p>
        ...
        <div className="px-4 pb-4">
          <p className="mb-2 font-sans text-[10px] font-semibold uppercase tracking-widest
                        text-kiro-muted dark:text-kiro-muted light:text-kiro-l-muted">
            Connect
          </p>
          <div className="flex items-center gap-3">
            {[
              { href: "https://github.com/dexnis8",              icon: <SiGithub size={16} />,      label: "GitHub" },
              { href: "https://linkedin.com/in/isaac-ayorinde",  icon: <SiLinkedin size={16} />,    label: "LinkedIn" },
              { href: "https://x.com/dexnis8",                   icon: <RiTwitterXFill size={16} />, label: "X" },
            ].map((s) => (
              <a
                key={s.label}
                href={s.href}
...
function SearchPanel() {
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="px-4 py-2 font-mono text-[11px] text-kiro-muted
                      dark:text-kiro-muted light:text-kiro-l-muted">
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="px-4 py-2 font-mono text-[11px] text-kiro-muted
        ...
        <p className="flex items-center gap-2">
          ...
          Branch: <span className="text-kiro-text dark:text-kiro-text light:text-kiro-l-text">main</span>
        </p>
